This is implementation of Symbian HTTP client.
...
This project implements the complete Symbian HTTP engine.

Limitations:
You can download two files only (1 text file and 1 image file)
